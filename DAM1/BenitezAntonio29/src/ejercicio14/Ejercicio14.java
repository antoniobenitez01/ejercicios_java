/*
 * Objetivo: Programa que muestra los billetes
 * mínimos necesarios para alcanzar la cantidad
 * de euros que introduzca el usuario.
...
public class Ejercicio14 
{
	public static void main(String[] args) 
	{
		...
		do
		{
			System.out.println("Introduzca un número de euros o introduzca 0 para apagar el programa.");
