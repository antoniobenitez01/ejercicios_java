...
public class Common 
{
	...
	//INPUT POSITIVE INT - Recoge un mensaje String y un objeto Scanner, comprueba si se introduce un valor Integer positivo correctamente
	public static int inputPositiveInt(String mensaje, Scanner entrada)
	{
		...
		do
		{
			//EXCEPCIÓN - InputMismatchException - Bucle que asegura que el valor introducido es un valor entero positivo
			try 
			{
				System.out.println(mensaje);
				num = entrada.nextInt();
	...
	//INPUT POSITIVE DOUBLE - Recoge un mensaje String y un objeto Scanner, comprueba si se introduce un valor Double positivo correctamente
	public static double inputPositiveDouble(String mensaje, Scanner entrada)
	{
		double num = 0;
		boolean inputTrue = false;
		do
	...
	public static boolean booleanCheck(String mensaje, Scanner entradaTeclado)
	{
		...
		do
		{
			...
			if(respuesta.toLowerCase().equals("subir"))
			{
				resultado = true;
				flag = true;
			}
			else if(respuesta.toLowerCase().equals("bajar"))
			{
				resultado = false;
				flag = true;
			}
